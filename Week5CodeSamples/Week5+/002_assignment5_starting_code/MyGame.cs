	...
	void LoadScene(int sceneNumber) {
		...
		switch (sceneNumber) {
			...
			case 5: // line segment:
				...
				_movers.Add(new Ball(0, new Vec2(290, 250)));
				_movers.Add(new Ball(0, new Vec2(455, 350)));
				break;
			case 6: // polygon:
				Ball.acceleration.SetXY(0, 1);
				...
				break;
			default: // one moving ball (medium speed), one fixed ball.
				Ball.acceleration.SetXY(0, 1);
				_movers.Add(new Ball(30, new Vec2(200, 300), new Vec2(0, 1)));
				//AddLine(new Vec2(700, 500), new Vec2(200, 500));
